            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/horarios/' . $horario->id . '/edit') }}" title="Edit Horario"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Laboratorio </th><td> {{ $horario->Laboratorio }} </td></tr><tr><th> Dia </th><td> {{ $horario->Dia }} </td></tr><tr><th> Hora </th><td> {{ $horario->Hora }} </td></tr>
                                </tbody>
                            </table>
                        </div>
